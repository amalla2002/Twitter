...
Time spent: **9** hours spent in total (this is omiting the some progress that was not committed and was lost)
...
* [P] User is using **"Twitter branded" colors and styles**
